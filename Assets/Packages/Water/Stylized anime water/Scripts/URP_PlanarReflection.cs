...
// Based on: https://github.com/Unity-Technologies/BoatAttack
    ...
    public class URP_PlanarReflection : MonoBehaviour
    {
        ...
        private void PlanarReflectionTexture(Camera cam)
        {
            if (_reflectionTex == null)
            {
                ...
                _reflectionTex = RenderTexture.GetTemporary(res.x, res.y, 16,
                    GraphicsFormatUtility.GetGraphicsFormat(hdrFormat, true));
            }
            _reflectionCamera.targetTexture =  _reflectionTex;
        }
        ...
        private void ExecutePlanarReflections(ScriptableRenderContext context, Camera camera)
        {
            ...
            Shader.SetGlobalTexture(_planarReflectionTextureId, _reflectionTex); // Assign texture to water shader
